...
//! binary is built with. The golden fixtures under
//! `tests/unit/fixtures/ledger_export/` are generated by a DEFAULT-feature
//! build and the SDK mirror under `tests/unit/fixtures/ledger_export_sdk/` by
//! an `all-extensions` build; keep them in their own lanes.
