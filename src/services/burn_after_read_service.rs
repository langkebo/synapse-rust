...
impl BurnAfterReadService {
    ...
    pub async fn set_burn_enabled(
        ...
        self.storage
            ...
            .await
            .map_err(|e| crate::common::ApiError::internal_with_log("Failed to set burn settings", &e))?;
    ...
    pub async fn get_pending_burns(&self, user_id: &str, room_id: &str) -> ApiResult<Vec<BurnEvent>> {
        let rows = self
            ...
            .await
            .map_err(|e| crate::common::ApiError::internal_with_log("Failed to get pending burns", &e))?;
    ...
    pub async fn cancel_burn(&self, user_id: &str, room_id: &str, event_id: &str) -> ApiResult<()> {
        self.storage
            ...
            .await
            .map_err(|e| crate::common::ApiError::internal_with_log("Failed to cancel burn", &e))?;
    ...
    pub async fn delete_burned_message(&self, user_id: &str, room_id: &str, event_id: &str) -> ApiResult<()> {
        ...
        self.storage
            ...
            .await
            .map_err(|e| crate::common::ApiError::internal_with_log("Failed to log burned event", &e))?;
    ...
    pub async fn set_user_default(&self, user_id: &str, default_burn_ms: i64) -> ApiResult<()> {
        self.storage
            ...
            .await
            .map_err(|e| crate::common::ApiError::internal_with_log("Failed to set user default", &e))?;
    ...
    pub async fn get_user_stats(&self, user_id: &str) -> ApiResult<BurnStats> {
        let row = self
            ...
            .await
            .map_err(|e| crate::common::ApiError::internal_with_log("Failed to get user stats", &e))?;
    ...
    pub async fn process_expired_burns(&self) -> ApiResult<Vec<BurnEvent>> {
        ...
        let expired_rows = self
            ...
            .await
            .map_err(|e| crate::common::ApiError::internal_with_log("Failed to get expired burns", &e))?;
