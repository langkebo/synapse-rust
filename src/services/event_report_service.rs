...
impl EventReportService {
    ...
    pub async fn create_report(&self, request: CreateEventReportRequest) -> Result<EventReport, ApiError> {
        ...
        let rate_check = self.storage.check_rate_limit(&request.reporter_user_id).await
        ...
        let report = self.storage.create_report(request.clone()).await
            .map_err(|e| ApiError::internal(format!("Failed to create report: {}", e)))?;

        self.storage.record_report(&request.reporter_user_id).await
    ...
    pub async fn get_report(&self, id: i64) -> Result<Option<EventReport>, ApiError> {
        let report = self.storage.get_report(id).await
    ...
    pub async fn get_reports_by_event(&self, event_id: &str) -> Result<Vec<EventReport>, ApiError> {
        let reports = self.storage.get_reports_by_event(event_id).await
    ...
    #[instrument(skip(self))]
    pub async fn get_reports_by_room(&self, room_id: &str, limit: i64, offset: i64) -> Result<Vec<EventReport>, ApiError> {
        let reports = self.storage.get_reports_by_room(room_id, limit, offset).await
            .map_err(|e| ApiError::internal(format!("Failed to get reports: {}", e)))?;
    ...
    #[instrument(skip(self))]
    pub async fn get_reports_by_reporter(&self, reporter_user_id: &str, limit: i64, offset: i64) -> Result<Vec<EventReport>, ApiError> {
        let reports = self.storage.get_reports_by_reporter(reporter_user_id, limit, offset).await
            .map_err(|e| ApiError::internal(format!("Failed to get reports: {}", e)))?;
    ...
    #[instrument(skip(self))]
    pub async fn get_reports_by_status(&self, status: &str, limit: i64, offset: i64) -> Result<Vec<EventReport>, ApiError> {
        let reports = self.storage.get_reports_by_status(status, limit, offset).await
            .map_err(|e| ApiError::internal(format!("Failed to get reports: {}", e)))?;
    ...
    #[instrument(skip(self))]
    pub async fn get_all_reports(&self, limit: i64, offset: i64) -> Result<Vec<EventReport>, ApiError> {
        let reports = self.storage.get_all_reports(limit, offset).await
            .map_err(|e| ApiError::internal(format!("Failed to get reports: {}", e)))?;
    ...
    #[instrument(skip(self))]
    pub async fn update_report(&self, id: i64, request: UpdateEventReportRequest, actor_user_id: &str) -> Result<EventReport, ApiError> {
        let old_report = self.storage.get_report(id).await
            .map_err(|e| ApiError::internal(format!("Failed to get report: {}", e)))?
            .ok_or_else(|| ApiError::not_found("Report not found"))?;

        let updated_report = self.storage.update_report(id, request.clone()).await
    ...
    #[instrument(skip(self))]
    pub async fn resolve_report(&self, id: i64, resolved_by: &str, resolution_reason: &str) -> Result<EventReport, ApiError> {
    ...
    pub async fn delete_report(&self, id: i64) -> Result<(), ApiError> {
        self.storage.delete_report(id).await
    ...
    pub async fn get_report_history(&self, report_id: i64) -> Result<Vec<EventReportHistory>, ApiError> {
        let history = self.storage.get_report_history(report_id).await
    ...
    pub async fn check_rate_limit(&self, user_id: &str) -> Result<ReportRateLimitCheck, ApiError> {
        let check = self.storage.check_rate_limit(user_id).await
            .map_err(|e| ApiError::internal(format!("Failed to check rate limit: {}", e)))?;
    ...
    pub async fn block_user_reports(&self, user_id: &str, blocked_until: i64, reason: &str) -> Result<(), ApiError> {
        self.storage.block_user_reports(user_id, blocked_until, reason).await
    ...
    pub async fn unblock_user_reports(&self, user_id: &str) -> Result<(), ApiError> {
        self.storage.unblock_user_reports(user_id).await
    ...
    pub async fn get_stats(&self, days: i32) -> Result<Vec<EventReportStats>, ApiError> {
        let stats = self.storage.get_stats(days).await
    ...
    pub async fn count_reports_by_status(&self, status: &str) -> Result<i64, ApiError> {
        let count = self.storage.count_reports_by_status(status).await
    ...
    pub async fn count_all_reports(&self) -> Result<i64, ApiError> {
        let count = self.storage.count_all_reports().await
            .map_err(|e| ApiError::internal(format!("Failed to count reports: {}", e)))?;
    ...
    #[instrument(skip(self))]
    pub async fn get_open_reports(&self, limit: i64, offset: i64) -> Result<Vec<EventReport>, ApiError> {
    ...
    pub async fn escalate_report(&self, id: i64, actor_user_id: &str) -> Result<EventReport, ApiError> {
        ...
        let updated = self.storage.update_report(id, request.clone()).await
