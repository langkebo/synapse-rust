...
pub(super) fn create_space_summary_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/spaces/{space_id}/summary/with_children", get(get_space_summary_with_children))
}
...
mod tests {
    ...
    fn test_summary_route_paths_are_scoped_under_spaces() {
        let paths = ["/spaces/{space_id}/summary", "/spaces/{space_id}/summary/with_children"];
