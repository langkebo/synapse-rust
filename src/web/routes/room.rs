use crate::web::routes::{
    ...
    get_event_keys, get_receipts, get_room_thread,
    get_power_levels, get_room_aliases, get_room_info, get_room_members, get_room_notifications,
    claim_room_keys, convert_room_event, forward_room_keys, get_room_account_data,
    get_room_capabilities, get_room_device, get_room_encrypted_events, get_room_event_url,
    get_room_key_count, get_room_keys, get_room_keys_version, get_room_message_queue,
    get_room_metadata, get_room_members_recent, get_room_membership, get_room_reduced_events,
    get_room_rendered, get_room_service_types, get_room_sync, get_room_thread_by_id,
    get_room_timeline, get_room_turn_server, get_room_unread_count, get_room_user_fragments,
    get_room_external_ids, get_room_event_perspective, get_room_invites, get_retention_policy,
    get_room_spaces,
    get_vault_data, search_room_messages, set_vault_data,
    sign_room_event, translate_room_event, verify_room_event,
    get_room_version,
    ...
    join_room, join_room_by_id_or_alias, kick_user, knock_room, leave_room, pinned, put_state_event,
    put_state_event_empty_key, put_state_event_no_key, redact_event, room_initial_sync,
    send_message, send_receipt, send_state_event, set_read_markers, set_room_account_data,
    sticky_event, unban_user,
    AppState,
};
use axum::{
...
fn create_room_v3_router() -> Router<AppState> {
    create_room_r0_v3_compat_router()
        ...
        .route("/rooms/{room_id}/vault_data", get(get_vault_data).put(set_vault_data))
        ...
        .route(
            "/rooms/{room_id}/room_keys/keys",
            put(forward_room_keys),
        )
        .route(
        ...
        .route(
            "/rooms/{room_id}/device/{device_id}",
            get(get_room_device),
        )
        .route(
