...
impl ThreepidStorage {
    ...
    pub async fn add_threepid(
        ...
        let threepid = sqlx::query_as::<_, UserThreepid>(
            ...
            RETURNING id, user_id, medium, address, validated_ts, added_ts, is_verified, verification_token, verification_expires_at
            "#,
        )
    ...
    pub async fn get_threepid(
        ...
        let threepid = sqlx::query_as::<_, UserThreepid>(
            r#"
            SELECT id, user_id, medium, address, validated_ts, added_ts, is_verified, verification_token, verification_expires_at
            FROM user_threepids
