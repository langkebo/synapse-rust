...
> **已归档（2026-06-18）**：本文件原位于 `docs/quality/PRODUCTION_DEPLOYMENT_GUIDE.md`，已合并到 [docs/synapse-rust/OPERATIONS.md](../OPERATIONS.md) 和 [docker/deploy/PRODUCTION_DEPLOYMENT_GUIDE.md](../../../docker/deploy/PRODUCTION_DEPLOYMENT_GUIDE.md)。
