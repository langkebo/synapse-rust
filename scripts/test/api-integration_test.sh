...
assert_success_json "Room Keys Distribution" "$HTTP_BODY" "$HTTP_STATUS"
...
if federation_http_json "Federation Knock" POST "$SERVER_URL/_matrix/federation/v1/knock/$FED_ROOM_ID_ENC/$FED_KNOCK_USER_ID_ENC"; then
