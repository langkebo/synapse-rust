...
#[test]
fn test_create_filter_request_construction() {
...
#[test]
fn test_create_filter_request_with_empty_content() {
    let request = CreateFilterRequest {
...
#[test]
fn test_create_filter_request_with_complex_content() {
    let content = json!({
        "room": {
...
#[test]
fn test_filter_struct_construction() {
    let filter = Filter {
        id: 42,
...
#[test]
fn test_create_filter_request_serialization() {
    let request = CreateFilterRequest {
