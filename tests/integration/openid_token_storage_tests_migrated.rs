...
#[tokio::test]
async fn test_create_openid_token_request_with_none_device_id() {
...
#[tokio::test]
async fn test_openid_token_struct_without_device_id() {
...
#[tokio::test]
async fn test_openid_token_serialization_roundtrip() {
    let token = OpenIdToken {
        id: 1,
