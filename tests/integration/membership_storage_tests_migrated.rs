...
#[tokio::test]
async fn test_room_member_struct_all_fields() {
...
#[tokio::test]
async fn test_room_member_struct_minimal() {
    let member = RoomMember {
...
#[tokio::test]
async fn test_room_member_serialization() {
    let member = RoomMember {
        room_id: "!room:localhost".to_string(),
        user_id: "@user:localhost".to_string(),
...
#[tokio::test]
async fn test_user_room_membership_struct() {
...
#[tokio::test]
async fn test_room_member_banned_state() {
    let member = RoomMember {
        room_id: "!room:localhost".to_string(),
...
#[tokio::test]
async fn test_room_member_invited_state() {
    let member = RoomMember {
        room_id: "!room:localhost".to_string(),
...
#[tokio::test]
async fn test_room_member_left_state() {
    let member = RoomMember {
        room_id: "!room:localhost".to_string(),
...
#[tokio::test]
async fn test_room_member_forgotten_state() {
    let member = RoomMember {
        room_id: "!room:localhost".to_string(),
...
async fn test_full_membership_lifecycle() {
    ...
    storage
        .add_member(&room_id, &user_id, "join", Some("LifecycleUser"), Some("Wanted to join"), None, None)
        .await
        .unwrap();
