...
#[tokio::test]
async fn test_create_session_writes_dual_pickle_columns() {
...
#[tokio::test]
async fn test_create_session_vodozemac_only_path() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_update_vodozemac_pickle_persists_new_ratchet() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_update_vodozemac_pickle_no_match_returns_false() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_promote_legacy_to_dual_succeeds() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_promote_to_dual_is_idempotent() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
    ...
    let second = storage.promote_to_dual(&session.session_id, "second_pickle", now_ms + 1000).await.unwrap();
...
#[tokio::test]
async fn test_promote_to_dual_skips_non_legacy_rows() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_list_legacy_sessions_pagination() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_list_legacy_sessions_clamps_limit() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_count_by_pickle_format() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
...
#[tokio::test]
async fn test_lazy_migration_end_to_end() {
    let pool = setup_test_database().await;
    let storage = MegolmSessionStorage::new(&pool);
