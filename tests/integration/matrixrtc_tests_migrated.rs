...
#[tokio::test]
async fn test_rtc_session_struct() {
...
#[tokio::test]
async fn test_rtc_membership_struct() {
...
#[tokio::test]
async fn test_rtc_encryption_key_struct() {
...
#[tokio::test]
async fn test_create_session_params() {
...
#[tokio::test]
async fn test_create_membership_params() {
...
#[tokio::test]
async fn test_session_with_memberships() {
    let session = RTCSession {
        id: 1,
        room_id: "!room:example.com".to_string(),
        session_id: "session123".to_string(),
...
#[tokio::test]
async fn test_application_types() {
