...
async fn test_friend_federation_flow() -> ApiResult<()> {
    ...
    let fed_result = federation
        .on_receive_friend_request("remote.example.com", event_content)
        .await;
    ...
    let check_result = federation
        .on_receive_friend_request("remote.example.com", malicious_content)
        .await;
