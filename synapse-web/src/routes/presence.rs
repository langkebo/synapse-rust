use crate::routes::{
    handlers::presence::{get_presence, get_presence_list, get_presence_list_no_path, presence_list, set_presence},
    AppState,
};
use axum::{
    routing::{get, post},
...
pub fn presence_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
...
mod tests {
    ...
    fn test_presence_router_keeps_list_endpoint_on_v3() {
        ...
        assert!(v3_only.iter().all(|path| path.starts_with("/_matrix/client/v3/")));
    }
}
