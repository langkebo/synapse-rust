...
impl UpdateSummaryBody {
    fn into_request(self) -> synapse_storage::room_summary::UpdateRoomSummaryRequest {
        synapse_storage::room_summary::UpdateRoomSummaryRequest {
            name: self.name,
            topic: self.topic,
...
pub fn room_summary_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
    use crate::routes::route_ledger::{expand_under_prefixes, RouteEntry};
    use axum::http::Method;
