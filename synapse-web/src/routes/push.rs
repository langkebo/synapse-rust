...
fn push_v3_only_absolute_routes() -> Vec<crate::routes::route_ledger::RouteEntry> {
...
pub fn push_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
...
async fn get_push_rules_scope(
    ...
    if scope == "global" {
        ...
        let defaults = crate::routes::push_rules::default_push_rules_for_user(&auth_user.user_id, username);
