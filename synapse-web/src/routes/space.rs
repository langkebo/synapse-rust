...
pub fn space_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
    crate::routes::route_ledger::expand_under_prefixes("space", SPACE_NEST_PREFIXES, &space_relative_routes())
}
