...
pub fn create_federation_router(state: &AppState) -> Router<AppState> {
    ...
    let protected = protected
        .layer(middleware::from_fn_with_state(fed_ctx.clone(), crate::middleware::federation_rate_limit_middleware))
        .layer(middleware::from_fn_with_state(fed_ctx, crate::middleware::federation_auth_middleware));
