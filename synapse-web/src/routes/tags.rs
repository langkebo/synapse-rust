...
pub fn tags_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
    crate::routes::route_ledger::expand_under_prefixes("tags", TAGS_NEST_PREFIXES, &tags_compat_relative_routes())
}
