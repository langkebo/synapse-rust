...
pub fn friend_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
...
async fn get_incoming_requests(
    ...
    let requests = state.services.extensions.friend_room_service.get_incoming_requests(&auth_user.user_id).await?;
...
async fn get_outgoing_requests(
    ...
    let requests = state.services.extensions.friend_room_service.get_outgoing_requests(&auth_user.user_id).await?;
...
async fn remove_friend(
    ...
    state.services.extensions.friend_room_service.remove_friend(&auth_user.user_id, &friend_id).await?;
...
async fn update_friend_note(
    ...
    state.services.extensions.friend_room_service.update_friend_note(&auth_user.user_id, &friend_id, &body.note).await?;
...
async fn update_friend_status(
    ...
    state.services.extensions.friend_room_service.update_friend_status(&auth_user.user_id, &friend_id, &body.status).await?;
...
async fn get_friend_status(
    ...
    let status = state.services.extensions.friend_room_service.get_friend_status(&auth_user.user_id, &friend_id).await?;
...
async fn check_friendship(
    ...
    let is_friend = state.services.extensions.friend_room_service.check_friendship(&auth_user.user_id, &target_id).await?;
...
async fn get_friend_suggestions(
    ...
    let suggestions =
        state.services.extensions.friend_room_service.get_friend_suggestions(&auth_user.user_id, query.limit).await?;
...
async fn get_friend_groups(
    ...
    let groups = state.services.extensions.friend_room_service.get_friend_groups(&auth_user.user_id).await?;
...
async fn create_friend_group(
    ...
    let group = state.services.extensions.friend_room_service.create_friend_group(&auth_user.user_id, &body.name).await?;
...
async fn delete_friend_group(
    ...
    state.services.extensions.friend_room_service.delete_friend_group(&auth_user.user_id, &group_id).await?;
...
async fn rename_friend_group(
    ...
    state.services.extensions.friend_room_service.rename_friend_group(&auth_user.user_id, &group_id, &body.name).await?;
...
async fn remove_friend_from_group(
    ...
    state.services.extensions.friend_room_service.remove_friend_from_group(&auth_user.user_id, &group_id, &user_id).await?;
...
async fn get_friends_in_group(
    ...
    let friends = state.services.extensions.friend_room_service.get_friends_in_group(&auth_user.user_id, &group_id).await?;
...
async fn get_groups_for_user(
    ...
    let groups = state.services.extensions.friend_room_service.get_groups_for_user(&auth_user.user_id, &user_id).await?;
...
async fn get_friend_dm(
    ...
    validate_user_id(&user_id)?;
    let room_id = state.services.extensions.friend_room_service.get_existing_dm_room_id(&auth_user.user_id, &user_id).await?;
