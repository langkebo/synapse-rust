...
use crate::routes::extractors::BackupId;
...
mod tests {
    ...
    fn test_serialize_room_key_request_statuses() {
        let pending = super::super::devices::serialize_room_key_request(synapse_e2ee::key_request::KeyRequestInfo {
        ...
        let cancelled = super::super::devices::serialize_room_key_request(synapse_e2ee::key_request::KeyRequestInfo {
