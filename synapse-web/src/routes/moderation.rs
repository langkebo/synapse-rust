use crate::routes::{get_scanner_info, report_event, report_room, update_report_score, AppState};
use axum::{
...
pub fn moderation_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
