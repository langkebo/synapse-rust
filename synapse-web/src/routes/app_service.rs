...
pub fn create_app_service_router(state: AppState) -> Router<AppState> {
    ...
    let admin_routes = Router::new()
        ...
        .route_layer(axum::middleware::from_fn_with_state(state, crate::middleware::admin_auth_middleware));

    public_routes.merge(admin_routes)
}

pub fn app_service_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
