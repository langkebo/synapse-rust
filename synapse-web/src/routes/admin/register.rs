...
use crate::routes::extractors::localhost_guard::{register_error_response, LocalhostGuard};
...
pub fn create_register_router(state: AppState) -> Router<crate::routes::AppState> {
    Router::new()
