...
use synapse_services::admin_federation_service::{
    ...
    encode_pending_federation_cursor, DestinationCursor,
};
...
pub fn admin_federation_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
...
fn validate_destinations_query(query: &DestinationsQuery) -> Result<(i32, Option<DestinationCursor>), ApiError> {
