...
pub fn admin_security_route_manifest() -> Vec<crate::routes::route_ledger::RouteEntry> {
...
pub async fn shadow_ban_user(
    ...
    state.services.core.auth_service.cache.delete(&format!("user:shadow_banned:{user_id}")).await;
