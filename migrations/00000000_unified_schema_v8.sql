...
-- Burn after read
CREATE INDEX IF NOT EXISTS idx_burn_pending_delete_at ON burn_after_read_pending(delete_at) WHERE is_processed = FALSE;
...
BEGIN
    ...
    RAISE NOTICE '  - spam_check_results/third_party_rule_results use 20260529 version';
