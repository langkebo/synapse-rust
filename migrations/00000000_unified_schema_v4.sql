-- ============================================================================
-- synapse-rust 统一数据库架构 v4.0.0
-- 创建日期: 2026-03-01
-- 说明: 完全符合 project_rules.md 规范的统一数据库架构
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_events_not_redacted ON events(room_id, origin_server_ts DESC) WHERE redacted = FALSE;
...
VALUES ('v4.0.0', 'init', 'unified_schema_v4')
...
BEGIN
    RAISE NOTICE '==========================================';
    RAISE NOTICE 'synapse-rust 统一数据库架构 v4.0.0 初始化完成';
