...
CREATE INDEX IF NOT EXISTS idx_olm_accounts_user_device ON olm_accounts(user_id, device_id);
...
CREATE INDEX IF NOT EXISTS idx_olm_sessions_expires_at ON olm_sessions(expires_at) WHERE expires_at IS NOT NULL;
