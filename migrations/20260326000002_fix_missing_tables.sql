...
CREATE INDEX IF NOT EXISTS idx_presence_user_status ON presence(user_id, presence);
...
CREATE INDEX IF NOT EXISTS idx_key_rotation_user_device ON key_rotation_history(user_id, device_id);
CREATE INDEX IF NOT EXISTS idx_key_rotation_rotated_ts ON key_rotation_history(rotated_ts DESC);
