...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_room_summaries_last_event_ts
ON room_summaries(last_event_ts DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_room_summaries_space
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_room_summary_members_user_membership_room
ON room_summary_members(user_id, membership, room_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_room_summary_members_room_membership_hero_active
ON room_summary_members(room_id, membership, is_hero DESC, last_active_ts DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_room_summary_members_room_hero_user
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_room_retention_policies_server_default
