...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_space_children_order ON space_children("order");
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_space_children_suggested ON space_children(suggested) WHERE suggested = TRUE;
