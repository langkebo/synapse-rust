...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_media_user ON media(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_media_created ON media(created_ts DESC);
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_sliding_sync_lists_unique ON sliding_sync_lists(user_id, device_id, COALESCE(conn_id, ''), list_key);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sliding_sync_lists_user_device ON sliding_sync_lists(user_id, device_id);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sliding_sync_tokens_user ON sliding_sync_tokens(user_id, device_id);
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_sliding_sync_rooms_unique ON sliding_sync_rooms(user_id, device_id, room_id, COALESCE(conn_id, ''));
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sliding_sync_rooms_user_device ON sliding_sync_rooms(user_id, device_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sliding_sync_rooms_bump_stamp ON sliding_sync_rooms(bump_stamp DESC);
