...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_media_usage_log_user ON media_usage_log(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_media_usage_log_timestamp ON media_usage_log(timestamp);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_media_quota_alerts_user ON media_quota_alerts(user_id) WHERE is_read = FALSE;
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_rendezvous_messages_session ON rendezvous_messages(session_id);
