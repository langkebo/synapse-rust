...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_device_keys_user_id ON device_keys(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_device_keys_device_id ON device_keys(device_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_cross_signing_keys_user_id ON cross_signing_keys(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_megolm_sessions_room_id ON megolm_sessions(room_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_megolm_sessions_sender_key ON megolm_sessions(sender_key);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_inbound_megolm_sessions_sender_key ON inbound_megolm_sessions(sender_key);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_key_backups_user_id ON key_backups(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_backup_keys_backup_id ON backup_keys(backup_id);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_friend_requests_receiver ON friend_requests(receiver_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_blocked_users_user_id ON blocked_users(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_private_sessions_user ON private_sessions(user_id_1, user_id_2);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_private_messages_session ON private_messages(session_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_voice_messages_user_id ON voice_messages(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_voice_messages_room_id ON voice_messages(room_id);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ip_blocks_blocked_at ON ip_blocks(blocked_at);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_ip_reputation_score ON ip_reputation(score);
