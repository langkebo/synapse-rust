...
BEGIN
    IF EXISTS (
        ...
        EXECUTE 'CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_threepids_medium_address ON user_threepids(medium, address)';
    END IF;
END
$$;
...
BEGIN
    IF EXISTS (
        ...
        EXECUTE 'CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_event_relations_thread ON event_relations(relation_thread_id)';
    END IF;
END
$$;
...
BEGIN
    IF EXISTS (
        ...
        EXECUTE 'CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_pusher_threepids_user ON pusher_threepids(user_id)';
    END IF;
END
$$;
...
BEGIN
    IF EXISTS (
        ...
        EXECUTE 'CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_device_keys_user_key_type ON device_keys(user_id, key_type)';
    END IF;
END
$$;
...
VALUES ('20260329_p2_optimization', 'P2 performance indexes: user_threepids, event_relations, pusher_threepids, device_keys', EXTRACT(EPOCH FROM NOW())::BIGINT * 1000)
