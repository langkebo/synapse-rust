...
impl SlidingSyncService {
            ...
            for range in &list_data.ranges {
                if range.len() >= 2 {
                    ...
                    let range_rooms = self
                        .storage
                        .get_rooms_for_list(synapse_storage::sliding_sync::SlidingSyncListQuery {
                            user_id,
                            device_id,
                            conn_id,
                            list_key,
    ...
    async fn count_rooms_for_list(
        ...
        conn_id: Option<&str>,
        list_key: &str,
        filters: Option<&synapse_storage::sliding_sync::SlidingSyncFilters>,
...
mod tests {
    use super::*;
    use synapse_storage::sliding_sync::SlidingSyncFilters;
