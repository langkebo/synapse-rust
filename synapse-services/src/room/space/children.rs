...
impl SpaceService {
    ...
    pub async fn add_child(&self, request: AddChildRequest) -> Result<SpaceChild, ApiError> {
        ...
        let child = self
            ...
            .add_child(request)
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to add child", e))?;
    ...
    pub async fn remove_child(&self, space_id: &str, room_id: &str, user_id: &str) -> Result<(), ApiError> {
        ...
        self.space_storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to remove child", e))?;
    ...
    pub async fn get_space_children_paginated(
        ...
        self.space_storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get paginated space children", e))
    }
    ...
    pub async fn get_space_hierarchy(&self, space_id: &str, max_depth: i32) -> Result<SpaceHierarchy, ApiError> {
        self.space_storage.get_space_hierarchy(space_id, max_depth).await.map_err(|e| {
            if matches!(e, sqlx::Error::RowNotFound) {
                ...
                ApiError::internal_with_cause("Failed to get space hierarchy", e)
            }
        })
    }
    ...
    pub async fn get_space_hierarchy_v1(
        ...
        self.space_storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get space hierarchy", e))
    }
    ...
    pub async fn get_recursive_hierarchy(
        ...
        self.space_storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get recursive hierarchy", e))
    }
