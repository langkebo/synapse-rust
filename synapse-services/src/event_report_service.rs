...
impl EventReportService {
    ...
    pub async fn create_report(&self, request: CreateEventReportRequest) -> Result<EventReport, ApiError> {
        ...
        let report = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to create report", &e))?;

        self.storage
            .record_report(&request.reporter_user_id)
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to record report", &e))?;
    ...
    pub async fn get_reports_by_event(&self, event_id: &str) -> Result<Vec<EventReport>, ApiError> {
        let reports = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to get reports", &e))?;
    ...
    pub async fn update_report(
        ...
        let updated_report = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to update report", &e))?;
    ...
    pub async fn block_user_reports(&self, user_id: &str, blocked_until: i64, reason: &str) -> Result<(), ApiError> {
        self.storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to block user", &e))?;
    ...
    pub async fn unblock_user_reports(&self, user_id: &str) -> Result<(), ApiError> {
        self.storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to unblock user", &e))?;
    ...
    pub async fn count_reports_by_status(&self, status: &str) -> Result<i64, ApiError> {
        let count = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to count reports", &e))?;
    ...
    pub async fn escalate_report(&self, id: i64, actor_user_id: &str) -> Result<EventReport, ApiError> {
        ...
        let updated = self
            ...
            .update_report(id, request.clone())
            .await
            .map_err(|e| ApiError::internal_with_context("Failed to escalate report", &e))?;
...
#[cfg(test)]
mod tests {
    fn create_test_report() -> synapse_storage::event_report::EventReport {
        synapse_storage::event_report::EventReport {
            id: 1,
    ...
    fn test_update_event_report_request() {
        let request = synapse_storage::event_report::UpdateEventReportRequest {
            status: Some("resolved".to_string()),
            score: Some(50),
    ...
    fn test_update_event_report_request_default() {
        let request = synapse_storage::event_report::UpdateEventReportRequest::default();
    ...
    fn test_report_rate_limit_check() {
        let check = synapse_storage::event_report::ReportRateLimitCheck {
            is_allowed: true,
            remaining_reports: 5,
            block_reason: None,
        };
