...
use synapse_storage::widget::{CreateWidgetParams, WidgetPermission, WidgetStoreApi};
pub use synapse_storage::widget::{Widget, WidgetSession};
use tracing::info;
use uuid::Uuid;
...
impl WidgetService {
    ...
    pub async fn create_widget(&self, user_id: &str, request: CreateWidgetRequest) -> Result<Widget, ApiError> {
        ...
        let widget = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to create widget", e))?;
    ...
    pub async fn get_widget(&self, widget_id: &str) -> Result<Option<Widget>, ApiError> {
        let widget = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get widget", e))?;
    ...
    pub async fn get_room_widgets(&self, room_id: &str) -> Result<Vec<Widget>, ApiError> {
        let widgets = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get room widgets", e))?;
    ...
    pub async fn get_user_widgets(&self, user_id: &str) -> Result<Vec<Widget>, ApiError> {
        let widgets = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get user widgets", e))?;
    ...
    pub async fn update_widget(
        ...
        let widget = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to update widget", e))?;
    ...
    pub async fn delete_widget(&self, widget_id: &str) -> Result<bool, ApiError> {
        let deleted = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to delete widget", e))?;
    ...
    pub async fn set_permission(
        ...
        let permission = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to set widget permission", e))?;
    ...
    pub async fn get_permissions(&self, widget_id: &str) -> Result<Vec<WidgetPermission>, ApiError> {
        let permissions = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get widget permissions", e))?;
    ...
    pub async fn get_user_permission(
        ...
        let permission = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get user widget permission", e))?;
    ...
    pub async fn delete_permission(&self, widget_id: &str, user_id: &str) -> Result<bool, ApiError> {
        let deleted = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to delete widget permission", e))?;
    ...
    pub async fn create_session(
        ...
        let session = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to create widget session", e))?;
    ...
    pub async fn get_session(&self, session_id: &str) -> Result<Option<WidgetSession>, ApiError> {
        let session = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get widget session", e))?;
    ...
    pub async fn update_session_activity(&self, session_id: &str) -> Result<bool, ApiError> {
        let updated = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to update session activity", e))?;
    ...
    pub async fn terminate_session(&self, session_id: &str) -> Result<bool, ApiError> {
        let terminated = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to terminate session", e))?;
    ...
    pub async fn get_widget_sessions(&self, widget_id: &str) -> Result<Vec<WidgetSession>, ApiError> {
        let sessions = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get widget sessions", e))?;
