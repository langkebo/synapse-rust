...
impl RelationsService {
    ...
    pub async fn send_annotation(&self, request: SendAnnotationRequest) -> Result<EventRelation, ApiError> {
        ...
        self.storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to create annotation", e))
    }
    ...
    pub async fn send_reference(&self, request: SendReferenceRequest) -> Result<EventRelation, ApiError> {
        ...
        self.storage
            .create_relation(params)
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to create reference", e))
    }
    ...
    pub async fn send_replacement(&self, request: SendReplacementRequest) -> Result<EventRelation, ApiError> {
        ...
        self.storage
            .create_relation(params)
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to create replacement", e))
    }
    ...
    pub async fn get_aggregations(
        ...
        let aggregations = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get aggregations", e))?;
    ...
    pub async fn redact_relation(&self, room_id: &str, event_id: &str, sender: &str) -> Result<(), ApiError> {
        let relation = self
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to get relation", e))?;
        ...
        self.storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to redact relation", e))?;
    ...
    pub async fn annotation_exists(
        ...
        self.storage
            ...
            .await
            .map_err(|e| ApiError::internal_with_cause("Failed to check annotation", e))
    }
}
