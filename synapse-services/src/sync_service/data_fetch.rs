    ...
    pub(crate) async fn get_state_events_for_sync_batch(
        ...
        let delta_state_by_room = if let Some(stream_ord) = params.since_stream_ordering {
            self.event_reader
                ...
                .await
                .map_err(|e| ApiError::internal_with_cause("Failed to get room state events", e))?
        } else {
            self.event_reader
        ...
        let full_state_for_newly_visible = if newly_visible_rooms.is_empty() {
            ...
            self.event_reader
                ...
                .await
                .map_err(|e| ApiError::internal_with_cause("Failed to get full state for newly visible rooms", e))?
        };
