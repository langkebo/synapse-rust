...
test_api "验证邮箱" "POST" "/_matrix/client/r0/register/email/submitToken" '{"sid":"test123","client_secret":"test123"}' "200" "完成邮箱验证"

# 跳过退出登录测试，因为会使token失效
...
test_api "获取用户资料" "GET" "/_matrix/client/r0/account/profile/@apitest:cjystx.top" "" "200" "返回用户资料"
test_api "更新显示名称" "PUT" "/_matrix/client/r0/account/profile/@apitest:cjystx.top/displayname" '{"displayname":"Admin User"}' "200" "更新用户显示名"
test_api "更新头像" "PUT" "/_matrix/client/r0/account/profile/@apitest:cjystx.top/avatar_url" '{"avatar_url":"mxc://example.com/avatar"}' "200" "更新用户头像"
# 跳过修改密码测试，因为会改变账户密码导致后续测试失败
...
echo ""
echo "--- 7. 在线状态 ---"
test_api "获取在线状态" "GET" "/_matrix/client/r0/presence/@apitest:cjystx.top/status" "" "200" "获取用户在线状态"
test_api "设置在线状态" "PUT" "/_matrix/client/r0/presence/@apitest:cjystx.top/status" '{"presence":"online","status_msg":"测试中"}' "200" "设置在线状态"

# 8. 房间管理
echo ""
echo "--- 8. 房间管理 ---"
test_api "创建房间" "POST" "/_matrix/client/r0/createRoom" '{"name":"测试房间","visibility":"private"}' "200" "创建新房间"
test_api "获取房间信息" "GET" "/_matrix/client/r0/directory/room/%21testroom:cjystx.top" "" "200" "获取房间信息"
...
test_api "获取用户房间列表" "GET" "/_matrix/client/r0/user/@apitest:cjystx.top/rooms" "" "200" "获取用户房间列表"

# 9. 房间操作
echo ""
echo "--- 9. 房间操作 ---"
test_api "加入房间" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/join" '{}' "200" "加入指定房间"
test_api "离开房间" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/leave" '{}' "200" "离开房间"
test_api "邀请用户" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/invite" '{"user_id":"@testuser2:cjystx.top"}' "200" "邀请用户加入房间"
test_api "踢出用户" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/kick" '{"user_id":"@testuser2:cjystx.top","reason":"测试"}' "200" "踢出房间成员"
test_api "封禁用户" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/ban" '{"user_id":"@apitest:cjystx.top","reason":"测试"}' "200" "封禁房间成员"
test_api "解除封禁" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/unban" '{"user_id":"@apitest:cjystx.top"}' "200" "解除封禁"

# 10. 房间状态和消息
echo ""
echo "--- 10. 房间状态和消息 ---"
test_api "获取房间状态" "GET" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/state" "" "200" "获取房间状态事件"
test_api "获取特定状态事件" "GET" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/state/m.room.name" "" "200" "获取特定状态事件"
test_api "设置房间状态" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/state/m.room.topic" '{"topic":"测试主题"}' "200" "设置房间状态事件"
test_api "获取成员事件" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/get_membership_events" '{"limit":10}' "200" "获取成员关系变更事件"
test_api "发送消息" "PUT" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/send/m.room.message/txn123" '{"msgtype":"m.text","body":"测试消息"}' "200" "发送房间消息"
test_api "获取房间消息" "GET" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/messages?limit=10" "" "200" "获取房间消息列表"
test_api "获取房间成员" "GET" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/members" "" "200" "获取房间成员列表"
test_api "编辑消息" "PUT" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/redact/%24event123" '{"reason":"编辑"}' "200" "编辑或删除消息"

# 11. 事件举报
echo ""
echo "--- 11. 事件举报 ---"
test_api "举报事件" "POST" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/report/%24event123" '{"reason":"垃圾内容","score":-100}' "200" "举报违规事件"
test_api "更新举报分数" "PUT" "/_matrix/client/r0/rooms/%21testroom:cjystx.top/report/%24event123/score" '{"score":-50}' "200" "更新举报分数"
